...
export default function Plant(): React.JSX.Element {
  ...
  const cardFloat = useAnimatedStyle(() => {
    ...
    return { transform: [{ translateY }, { scale }], elevation, shadowOpacity, shadowRadius };
  });
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, color: "#111", fontFamily: F.bold },
  subtitle: { marginTop: 2, fontSize: 14, color: "#6B7280", fontFamily: F.medium },

  gaugeWrap: { marginLeft: 12 },
  gaugeCenter: { alignItems: "center", justifyContent: "center" },
  gaugeLabel: { fontSize: 10, color: "#6B7280", fontFamily: F.medium },
  gaugeValue: { marginTop: -2, fontSize: 16, color: "#111", fontFamily: F.bold },
  ...
  labelText: { fontSize: 15, color: "#111", fontFamily: F.semibold },
  labelValue: { marginLeft: "auto", fontSize: 15, color: "#111", fontFamily: F.bold },
